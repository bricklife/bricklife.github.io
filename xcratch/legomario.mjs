...
var encoding = createCommonjsModule(function (module) {
  ...
  (function (global) {
    ...
    if (module.exports && !global["encoding-indexes"]) {
      global["encoding-indexes"] = encodingIndexes["encoding-indexes"];
    } //
    // Utilities
    //
    ...
    function GB18030Encoder(options, gbk_flag) {
      options.fatal; // gb18030's decoder has an associated gbk flag (initially unset).
    ...
    function ISO2022JPEncoder(options) {
      options.fatal; // iso-2022-jp's encoder has an associated iso-2022-jp encoder
...
var Hub = /*#__PURE__*/function () {
  function Hub(runtime, extensionId) {
    var hubId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  _createClass(Hub, [{
    ...
    value: function _onMessage(base64) {
      ...
      if (length > 127) {
        log.warn("Unsupported message length: ".concat(length));
        return;
      }
        ...
        case MessageType.PORT_VALUE:
          {
            ...
            if (device) {
              ...
              log.debug(_portId, device.inputValues);
            }
...
var logByteArray = function logByteArray(prefix, array) {
  bytes = array.reduce(function (output, elem) {
    return output + ('0' + (elem & 0xff).toString(16)).slice(-2) + ' ';
  }, '');
  log.debug("".concat(prefix, " ").concat(bytes));
};
